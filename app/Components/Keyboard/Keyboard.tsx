...
function Keyboard({ game }: KeyboardProps) {
  ...
  const onKeyDownHandler = (event: any) => {
    ...
    if (game.letters.includes(letterPlayed) && !game.lettersPlayed.includes(letterPlayed) && game.state === GameState.PENDING) {
  ...
  return (
    <div tabIndex={-1} className={classNames(styles.container)} onKeyDown={onKeyDownHandler} ref={keyboardRef} >
